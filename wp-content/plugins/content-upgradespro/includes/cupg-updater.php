...
class Cupg_Updater {
    ...
    function __construct($current_version, $update_path, $plugin_slug) {
            ...
            $status = json_decode(get_option('coupg_rinfo'), true);
     ...
     */
    private function analyze_response($response_body) {
        if ($response_body === '') {
            Cupg_Helpers::check_status( json_encode(array('code' => '', 'domain' => get_site_url(), 'activated' => false)) );
            return false;
        }
