	...
	<div class="tabck menustyles current" id="tab_images">
		...
		<div class="slides_source" data-source="slidemanager">
			<div id="ckslides">
				...
				<?php if ($this->ispro) { ?>
				<input name="ckimportslidesfromfolder" id="ckimportslidesfromfolder" type="button" value="<?php _e('Import slides from a folder') ?>" class="button button-secondary" onclick="ckImportSlidesFromFolder();"/>
				<?php } ?>
