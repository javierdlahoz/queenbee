					...
					<div id="postbox-container-2" class="postbox-container">
						<div id="advanced" class="meta-box-sortables">
							<div id="gallery_bank_get_started" class="postbox" >
								...
								<h3 class="hndle"><span><?php _e("System Status", "gallery-bank"); ?></span></h3>
								<div class="inside">
									<div id="ux_system_settings" class="gallery_bank_layout">
										<a class="btn btn-info system-report" href="#"><?php _e("Get System Report", "gallery-bank"); ?></a>
										<div id="system-report" class="layout-system-report">
											<textarea readonly="readonly"></textarea>
										</div>
										<a class="btn btn-info close-report" href="#"><?php _e("Close System Report", "gallery-bank"); ?></a>
																	...
																	<span>
																		...
																		foreach ($active_plugins as $plugin) {
																																...
																																if (!empty($plugin_data["Name"])) {
																																		...
																																		if (strstr($dirname, "gallery-bank")) {
