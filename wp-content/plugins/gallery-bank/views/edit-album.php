...
if(!defined("ABSPATH")) exit; //exit if accessed directly
	...
	else
	{
					...
					<div id="postbox-container-2" class="postbox-container">
						<div id="advanced" class="meta-box-sortables">
							<div id="gallery_bank_get_started" class="postbox" >
								...
								<h3 class="hndle"><span><?php _e("Album", "gallery-bank"); ?></span></h3>
								<div class="inside">
									<div id="ux_edit_album" class="gallery_bank_layout">
										...
										<button type="submit" class="btn btn-info" style="float:right"><?php _e("Save Album", "gallery-bank"); ?></button>
										<div class="separator-doubled"></div>
										<div id="update_album_success_message" class="custom-message green" style="display: none;">
											<span>
												<strong><?php _e("Album Saved. Kindly wait for the redirect to happen.", "gallery-bank"); ?></strong>
											</span>
										</div>
											...
											<div class="layout-span12">
												<div class="widget-layout">
													<div class="widget-layout-title">
														<h4><?php _e("Album Details", "gallery-bank"); ?></h4>
													</div>
																	<div class="widget-layout-body">
																			<div class="layout-control-group">
																					<label class="layout-control-label"><?php _e("Album Title", "gallery-bank"); ?> :</label>
																					<div class="layout-controls">
																							<input type="text" name="ux_edit_title" class="layout-span12"
																									 ...
																									 id="ux_edit_title"
																									 placeholder="<?php _e("Enter your Album Title", "gallery-bank"); ?>"/>
																					</div>
																			</div>
																	...
																	<div class="widget-layout-body">
																			<div class="layout-control-group">
																					<label class="layout-control-label"><?php _e("Description", "gallery-bank"); ?> :</label>
																			</div>
																			<div class="layout-control-group">
																					<?php
										...
										<div class="custom-message red" style="margin:0px;">
											<span style="line-height: inherit;">
												<?php echo( sprintf( __( "<b>Notice:</b> Your server allows you to upload <b>%s</b> files of maximum total <b>%s</b> bytes and allows <b>%s</b> seconds to complete.", "gallery-bank" ), $max_files_upload, $max_files_size, $max_files_time));?>
												<?php _e( "<br />If your request exceeds these limitations, it will fail, probably without an errormessage.", "gallery-bank"); ?>
												<?php _e( "<br />Additionally your hosting provider may have set other limitations on uploading files.", "gallery-bank"); ?>
										...
										<div class="fluid-layout">
											<div class="layout-span7">
															<div class="widget-layout">
																	<div class="widget-layout-title">
																			<h4><?php _e("Upload Images", "gallery-bank"); ?></h4>
																	</div>
																	<div class="widget-layout-body" id="edit_image_uploader">
																			<p><?php _e("Your browser doesn\"t have Flash, Silverlight or HTML5 support.", "gallery-bank") ?></p>
																	</div>
															</div>
											</div>
											<div class="layout-span5">
															<div class="widget-layout">
																	<div class="widget-layout-title">
																			<h4><?php _e("Upload Videos", "gallery-bank"); ?>
																	...
																	<div class="widget-layout-body" id="edit_video_uploader">
																			<div class="layout-control-group">
																					<label class="layout-control-label custom_gallery_layout_label"><?php _e("Video Url", "gallery-bank"); ?> :</label>
																					<div class="layout-controls custom_gallery_layout_control">
																							<input type="text" name="ux_edit_txt_video_url" class="layout-span12" value=""
																									 ...
																									 placeholder="<?php _e("Enter your Video Url", "gallery-bank"); ?>"/>
																					</div>
																			</div>
																			<div class="layout-control-group">
																					<div class="layout-controls">
																							<button type="button" onclick="insertVideoToDataTable();" style="float:right"
																											class="btn btn-info"><?php _e("Upload Video", "gallery-bank"); ?></button>
																					</div>
																			</div>
																	</div>
															</div>
										...
										<div class="fluid-layout">
											<div class="layout-span12">
												<div class="widget-layout">
													<div class="widget-layout-title">
														<h4><?php _e("Your Gallery Bank Album", "gallery-bank"); ?></h4>
													</div>
													<div class="widget-layout-body">
																...
																<tr>
																								<th style="width:11%">
																										...
																										<button type="button" onclick="deleteSelectedImages();" style="vertical-align:middle;"
																														class="btn btn-inverse"><?php _e("Delete", "gallery-bank"); ?></button>
																								</th>
																								<th style="width:15%">
																										<?php _e("Thumbnail", "gallery-bank"); ?>
																								</th>
																								<th style="width:25%">
																										<?php _e("Title & Description", "gallery-bank"); ?>
																								</th>
																								<th style="width:20%">
																										<?php _e("Tags (comma separated list)", "gallery-bank"); ?>
																										<i class="widget_premium_feature"><?php _e(" (Available in Premium Editions)", "gallery-bank"); ?></i>
																								</th>
																								<th style="width:25%">
																										<?php _e("Url to Redirect on click of an Image", "gallery-bank"); ?>
																								</th>
																								<th style="width:5%"></th>
											...
											<div class="separator-doubled"></div>
										<button type="submit" class="btn btn-info" style="float:right; margin-top: 20px;"><?php _e("Save Album", "gallery-bank"); ?></button>
										<a class="btn btn-inverse" href="admin.php?page=gallery_bank" style="margin-top: 20px;"><?php _e("Back to Albums", "gallery-bank"); ?></a>
									</div>
								</div>
							</div>
						</div>
		...
		jQuery(document).ready(function()
		{
			...
			{
				var r = confirm("<?php _e("Are you sure you want to delete this Image?", "gallery-bank")?>");
				if (r == true)
				{
			...
			{
				 alert("<?php _e( "This feature is only available in Premium Editions!", "gallery-bank" ); ?>");
			}
