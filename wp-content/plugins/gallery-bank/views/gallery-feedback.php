				...
				<div id="postbox-container-2" class="postbox-container">
					<div id="advanced" class="meta-box-sortables">
						<div id="gallery_bank_get_started" class="postbox" >
							...
							<h3 class="hndle"><span><?php _e("Feature Requests", "gallery-bank"); ?></span></h3>
							<div class="inside">
								<div id="ux_feedback" class="gallery_bank_layout">
									...
									<div id="email_success_message" class="custom-message green" style="display: none;">
										<span>
											<strong><?php _e("Email has been sent successfully.", "gallery-bank"); ?></strong>
										</span>
									</div>
										...
										<div class="layout-span12">
											<div class="widget-layout">
												<div class="widget-layout-title">
													<h4><?php _e("Feature Requests / Suggestions", "gallery-bank"); ?></h4>
												</div>
												<div class="widget-layout-body">
													<div class="layout-control-group">
														<label class="layout-control-label"><?php _e("Name", "gallery-bank"); ?> : <span class="error">*</span></label>
														<div class="layout-controls">
															<input type="text" class="layout-span12" name="ux_name" id="ux_name" placeholder="<?php _e("Enter your Name", "gallery-bank"); ?>"/>
														</div>
													</div>
													<div class="layout-control-group">
														<label class="layout-control-label"><?php _e("Email Id", "gallery-bank"); ?> : <span class="error">*</span></label>
														<div class="layout-controls">
															<input type="text" class="layout-span12" name="ux_email" id="ux_email" placeholder="<?php _e("Enter your Email Address", "gallery-bank"); ?>"/>
														</div>
													</div>
													<div class="layout-control-group">
														<label class="layout-control-label"><?php _e("Feature Requests / Suggestions", "gallery-bank"); ?> : <span class="error">*</span></label>
														<div class="layout-controls">
															<textarea rows="5" class="layout-span12" name="ux_suggestion" id="ux_suggestion" placeholder="<?php _e("Enter your Feature Requests / Suggestions", "gallery-bank"); ?>"></textarea>
														</div>
													</div>
													<div class="layout-control-group">
														<div class="layout-controls">
															<button type="submit" class="btn btn-danger"><?php _e("Send", "gallery-bank"); ?></button>
														</div>
													</div>
												</div>
											</div>
