<?php
				...
				<div id="postbox-container-2" class="postbox-container">
					<div id="advanced" class="meta-box-sortables">
						<div id="gallery_bank_get_started" class="postbox" >
							...
							<h3 class="hndle"><span><?php _e("Gallery Bank Dashboard", "gallery-bank"); ?></span></h3>
							<div class="inside">
								<div id="ux_dashboard" class="gallery_bank_layout">
									...
									{
										?>
										<a class="btn btn-info" href="admin.php?page=save_album&album_id=<?php echo count($last_album_id) == 0 ? 1 : $last_album_id + 1; ?>"><?php _e("Add New Album", "gallery-bank");?></a>
										<?php
									}
									?>


									<a class="btn btn-danger" href="#" onclick="delete_all_albums();"><?php _e("Delete All Albums", "gallery-bank");?></a>
									<a class="btn btn-danger" href="#" onclick="purge_all_images();"><?php _e("Purge Images & Albums", "gallery-bank");?></a>
									<a class="btn btn-danger" href="#" onclick="restore_factory_settings();"><?php _e("Restore Factory Settings", "gallery-bank");?></a>
										...
										<div class="layout-span12">
											<div class="widget-layout">
												<div class="widget-layout-title">
													<h4><?php _e( "Existing Albums Overview", "gallery-bank" ); ?></h4>
												</div>
												<div class="widget-layout-body">
													<table class="table table-striped " id="data-table-album">
														<thead>
															<tr>
																<th style="width:24%"><?php _e( "Thumbnail", "gallery-bank" ); ?></th>
																<th style="width:13%"><?php _e( "Title", "gallery-bank" ); ?></th>
																<th style="width:14%"><?php _e( "Total Images", "gallery-bank" ); ?></th>
																<th style="width:14%"><?php _e( "Date", "gallery-bank" ); ?></th>
																<th style="width:14%"><?php _e( "Short-Codes", "gallery-bank" ); ?></th>
																	...
																	<tr>
																		...
																		<td>
																			<ul class="layout-table-controls">
																				...
																				<li>
																					<a class="btn hovertip "  style="cursor: pointer;" data-original-title="<?php _e( "Delete Album", "gallery-bank")?>" onclick="delete_album(<?php echo $album[$flag]->album_id;?>);" >
	...
	<script type="text/javascript">
		...
		{
			var r = confirm("<?php _e( "Are you sure you want to delete this Album?", "gallery-bank" ); ?>");
			if(r == true)
			{
