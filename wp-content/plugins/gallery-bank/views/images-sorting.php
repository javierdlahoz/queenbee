	...
	if(isset($pics_order))
	{
		if (count($album_css) != 0)
		{
				...
				<style type="text/css">
						...
						.layout-controls > a#<?php echo isset($_REQUEST["order_id"]) ? intval($_REQUEST["order_id"]) : '';?>
						{
					...
					<div id="postbox-container-2" class="postbox-container">
						<div id="advanced" class="meta-box-sortables">
							<div id="gallery_bank_get_started" class="postbox" >
								...
								<h3 class="hndle"><span><?php _e("Re-Order Images", "gallery-bank"); ?></span></h3>
								<div class="inside">
									<div id="ux_image_sorting" class="gallery_bank_layout">
										<a class="btn btn-inverse"
																 href="admin.php?page=gallery_bank"><?php _e("Back to Albums", "gallery-bank"); ?></a>
															<a href="#" class="btn btn-info" onclick="show_premium_message();"
																			style="float:right"><?php _e("Update Order", "gallery-bank"); ?></a>
															<div id="sort_order_message" class="custom-message green" style="display: none;">
											<span>
												<strong><?php _e("Sorting Order has been updated.", "gallery-bank"); ?></strong>
											</span>
															</div>
