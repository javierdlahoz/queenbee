...
else
{
	...
	if (count($album_css) != 0) {
					...
					<div id="postbox-container-2" class="postbox-container">
						<div id="advanced" class="meta-box-sortables">
							<div id="gallery_bank_get_started" class="postbox" >
								...
								<h3 class="hndle"><span><?php _e("Global Settings", "gallery-bank"); ?></span></h3>
								<div class="inside">
									<div id="ux_global_settings" class="gallery_bank_layout">
										<a class="btn btn-inverse" href="admin.php?page=gallery_bank"><?php _e("Back to Albums", "gallery-bank"); ?></a>
										<a onclick="show_premium_message();" href="#" class="btn btn-info" style="float:right"><?php _e("Update Settings", "gallery-bank"); ?></a>
										...
										<div class="fluid-layout">
											<div class="layout-span6">
												<div class="widget-layout">
													<div class="widget-layout-title">
														<h4>
															<?php _e("Thumbnail Settings", "gallery-bank"); ?>
															<i class="widget_premium_feature"><?php _e(" (Available in Premium Editions)", "gallery-bank"); ?></i>
														</h4>
														<span class="tools">
													...
													<div id="thumbnail_settings" class="collapse in">
														<div class="widget-layout-body">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Thumbnail Size", "gallery-bank"); ?> : </label>
																<div class="layout-controls-radio">
																	...
																	if ($thumbnails_custom_enable == 1) {
																		...
																		style="vertical-align: baseline;"><?php _e("Original", "gallery-bank"); ?></label>
																		...
																		<?php _e("Custom", "gallery-bank"); ?> </label>
																		<?php
																	} else {
																		?>
																		<input type="radio" name="ux_thumbnail" value="1" onclick="check_thumbnail_settings();"/>
																		<label style="vertical-align: baseline;"><?php _e("Original", "gallery-bank"); ?></label>
														...
														<div class="widget-layout-body" id="image_width">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Width", "gallery-bank"); ?> : </label>
														...
														<div class="widget-layout-body" id="image_height">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Height", "gallery-bank"); ?> : </label>
																<div class="layout-controls">
														...
														<div class="widget-layout-body">
															<div class="layout-control-group">
																...
																id="ux_label_thumb_opacity"><?php _e("Opacity", "gallery-bank"); ?> : </label>
																<div class="layout-controls">
														...
														<div class="widget-layout-body">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Border Size", "gallery-bank"); ?> : </label>
																<div class="layout-controls">
														...
														<div class="widget-layout-body">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Border Radius", "gallery-bank"); ?> : </label>
																<div class="layout-controls">
														...
														<div class="widget-layout-body">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Border Color", "gallery-bank"); ?> : </label>
																<div class="layout-controls">
														...
														<div class="widget-layout-body">
										 					<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Margin Between Images", "gallery-bank"); ?> : </label>
																<div class="layout-controls">
														...
														<div class="widget-layout-body">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Text Color", "gallery-bank"); ?> : </label>
																<div class="layout-controls">
														...
														<div class="widget-layout-body">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Text-Align", "gallery-bank"); ?> : </label>
																<div class="layout-controls">
														...
														<div class="widget-layout-body">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Font-Family", "gallery-bank"); ?> : </label>
																<div class="layout-controls">
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Heading Font-Size", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls">
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Text Font-Size", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls">
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Description Length", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls">
												...
												<div class="widget-layout">
													<div class="widget-layout-title">
														<h4><?php _e("Album Cover Settings", "gallery-bank"); ?>
															<i class="widget_premium_feature"><?php _e(" (Available in Premium Editions)", "gallery-bank"); ?></i>
														</h4>
														<span class="tools">
													...
													<div id="album_cover_settings" class="collapse in">
														<div class="widget-layout-body">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Cover Size", "gallery-bank"); ?> : </label>
																<div class="layout-controls-radio">
																	<?php
																	...
																	?>
																		...
																		<input type="radio" style="margin-left: 10px;" name="ux_cover_size" value="0"
																			onclick="check_cover_settings();"/> <label
																			style="vertical-align: baseline;"><?php _e("Custom", "gallery-bank"); ?></label>
																	<?php
																	} else {
																		?>
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label" id="ux_label_cover_opacity"><?php _e("Opacity", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls">
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Margin Between Albums", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls">
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Text for Album Click", "gallery-bank"); ?> : </label>
						    					...
						    					<div class="widget-layout">
						        					<div class="widget-layout-title">
						           						 <h4><?php _e("Filter Settings", "gallery-bank"); ?>
						           						 	<i class="widget_premium_feature"><?php _e(" (Available in Premium Editions)", "gallery-bank"); ?></i>
						           						 </h4>
														<span class="tools">
													...
													<div id="filter_settings" class="collapse">
						            					<div class="widget-layout-body">
										                	<div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Filters", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls-radio">
											                        <?php
											                        if ($filters_setting == 1) {
											                            ...
											                            <input type="radio" onclick="show_filter_page();" name="ux_image_filters" value="1"
											                                ...
											                                style="vertical-align: baseline;"><?php _e("Enable", "gallery-bank"); ?></label>
											                            <input type="radio" onclick="show_filter_page();" style="margin-left: 10px;"
											                                   name="ux_image_filters" value="0"/> <label
											                                style="vertical-align: baseline;"><?php _e("Disable", "gallery-bank"); ?></label>
											                        <?php
											                        } else {
											                            ?>
						            					...
						            					<div id="ux_filter_setting_div" style="display:none;">
						                					<div class="widget-layout-body">
											                    <div class="layout-control-group">
											                        <label class="layout-control-label"><?php _e("Filter Color", "gallery-bank"); ?> : </label>
											                        <div class="layout-controls">
											                ...
											                <div class="widget-layout-body">
											                    <div class="layout-control-group">
											                        <label class="layout-control-label"><?php _e("Filter Text Color", "gallery-bank"); ?> : </label>
											                        <div class="layout-controls">
											                ...
											                <div class="widget-layout-body">
											                    <div class="layout-control-group">
											                        <label class="layout-control-label"><?php _e("Font-Size", "gallery-bank"); ?> : </label>
											                        <div class="layout-controls">
						    					...
						    					<div class="widget-layout">
											        <div class="widget-layout-title">
											            <h4><?php _e("Roles & Capabilities", "gallery-bank"); ?>
											            	<i class="widget_premium_feature"><?php _e(" (Available in Premium Editions)", "gallery-bank"); ?></i>
											            </h4>
															<span class="tools">
								        			...
								        			<div id="capabilities_settings" class="collapse">
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Privileges for Admin", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls-radio">
											                        <input type="checkbox" id="ux_full_control_to_admin" onclick="disable_admin_checkbox(this);"
											                            ...
											                            style="vertical-align: baseline;"><?php _e("Full Control", "gallery-bank"); ?></label>
											                        <input type="checkbox" id="ux_read_control_to_admin" name="ux_read_control_to_admin" value="1"
											                               style="margin-left: 10px;"/><label
											                            style="vertical-align: baseline;"><?php _e("Read", "gallery-bank"); ?></label>
											                        <input type="checkbox" id="ux_write_control_to_admin" name="ux_write_control_to_admin" value="1"
											                               style="margin-left: 10px;"/><label
											                            style="vertical-align: baseline;"><?php _e("Write", "gallery-bank"); ?></label>
											                    </div>
											                </div>
											            </div>
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Privileges for Editor", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls-radio">
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Privileges for Author", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls-radio">
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Privileges for Contributor", "gallery-bank"); ?>
											                        : </label>
											                    <div class="layout-controls-radio">
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Privileges for Subscriber", "gallery-bank"); ?>
											                        : </label>
											                    <div class="layout-controls-radio">
											...
											<div class="layout-span6">
												<div class="widget-layout">
													<div class="widget-layout-title">
														<h4><?php _e("Lightbox Settings", "gallery-bank"); ?>
															<i class="widget_premium_feature"><?php _e(" (Available in Premium Editions)", "gallery-bank"); ?></i>
														</h4>
															<span class="tools">
													...
													<div id="lightbox_settings" class="collapse in">
														<div class="widget-layout-body">
															<div class="layout-control-group">
																<label class="layout-control-label"><?php _e("Lightbox Type", "gallery-bank"); ?> : </label>
													            <div class="layout-controls">
													    ...
													    <div class="widget-layout-body">
													        <div class="layout-control-group">
													            <label class="layout-control-label"><?php _e("Opacity", "gallery-bank"); ?> : </label>
													            <div class="layout-controls">
													    ...
													    <div class="widget-layout-body">
													        <div class="layout-control-group">
													            <label class="layout-control-label"><?php _e("Inline Background", "gallery-bank"); ?> : </label>
													            <div class="layout-controls">
													    ...
													    <div class="widget-layout-body">
													        <div class="layout-control-group">
													            <label class="layout-control-label"><?php _e("Overlay Background", "gallery-bank"); ?> : </label>
													            <div class="layout-controls">
													    ...
													    <div class="widget-layout-body">
													        <div class="layout-control-group">
													            <label class="layout-control-label"><?php _e("Fade In Time", "gallery-bank"); ?> : </label>
													            <div class="layout-controls">
													    ...
													    <div class="widget-layout-body">
													        <div class="layout-control-group">
													            <label class="layout-control-label"><?php _e("Fade Out Time", "gallery-bank"); ?> : </label>
													            <div class="layout-controls">
													    ...
													    <div class="widget-layout-body">
													        <div class="layout-control-group">
													            <label class="layout-control-label"><?php _e("Facebook Comments", "gallery-bank"); ?> : </label>
													            <div class="layout-controls-radio">
													                <?php
													    ...
													    <div class="widget-layout-body">
													        <div class="layout-control-group">
													            <label class="layout-control-label"><?php _e("Social Sharing", "gallery-bank"); ?> : </label>
													            <div class="layout-controls-radio">
													                <?php
													                if ($social_sharing == 1) {
													                    ?>
													    ...
													    <div class="widget-layout-body">
													        <div class="layout-control-group">
													            <label class="layout-control-label"><?php _e("Image Title", "gallery-bank"); ?> : </label>
													            <div class="layout-controls-radio">
													                <?php
													                ...
													                <?php
													                    ...
													                    <label style="vertical-align: baseline;"><?php _e("Disable", "gallery-bank"); ?></label>
													                <?php
													                }
													                ?>
													            </div>
													    ...
													    <div class="widget-layout-body">
													        <div class="layout-control-group">
													            <label class="layout-control-label"><?php _e("Image Description", "gallery-bank"); ?> : </label>
													            <div class="layout-controls-radio">
													                <?php
						    					...
						    					<div class="widget-layout">
													<div class="widget-layout-title">
														<h4><?php _e("Front - End Layout Settings", "gallery-bank"); ?>
															<i class="widget_premium_feature"><?php _e(" (Available in Premium Editions)", "gallery-bank"); ?></i>
														</h4>
															<span class="tools">
						        					...
						        					<div id="frontend_settings" class="collapse">
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Text for Back Button", "gallery-bank"); ?> : </label>
						            					...
						            					<div class="widget-layout-body">
						                					<div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Button Color", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls">
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Button Text Color", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls">
											            ...
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Album Seperator", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls-radio">
											                        <?php
						    					...
						    					<div class="widget-layout">
											        <div class="widget-layout-title">
											            <h4><?php _e("Pagination Settings for Images", "gallery-bank"); ?>
											            	<i class="widget_premium_feature"><?php _e(" (Available in Premium Editions)", "gallery-bank"); ?></i>
											            </h4>
														<span class="tools">
											        ...
											        <div id="pagination_settings" class="collapse">
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Paging", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls-radio">
											                        <?php
											                        ...
											                        <?php
											                            ...
											                            <label style="vertical-align: baseline;"><?php _e("Enable", "gallery-bank"); ?></label>
											                            <input type="radio" style="margin-left: 10px;" name="ux_images_paging" value="0"
											            ...
											            <div class="widget-layout-body" id="ux_images_per_page_div" style="display: none;">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("No. of Images Per Page ", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls">
						    					...
						    					<div class="widget-layout">
											        <div class="widget-layout-title">
											            <h4><?php _e("Slide Show Settings", "gallery-bank"); ?>
											            	<i class="widget_premium_feature"><?php _e(" (Available in Premium Editions)", "gallery-bank"); ?></i>
											            </h4>
														<span class="tools">
											        ...
											        <div id="slideshow_settings" class="collapse">
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Auto Play", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls-radio">
											                        <?php
											            ...
											            <div class="widget-layout-body" id="ux_slide_interval_div">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Interval", "gallery-bank"); ?> : </label>
											                    <div class="layout-controls">
						    					...
						    					<div class="widget-layout">
											        <div class="widget-layout-title">
											            <h4><?php _e("Language Direction Settings", "gallery-bank"); ?>
											            	<i class="widget_premium_feature"><?php _e(" (Available in Premium Editions)", "gallery-bank"); ?></i>
											            </h4>
														<span class="tools">
											        ...
											        <div id="lang_dir_settings" class="collapse">
											            <div class="widget-layout-body">
											                <div class="layout-control-group">
											                    <label class="layout-control-label"><?php _e("Language Direction", "gallery-bank"); ?> : </label>
	    ...
	    {
	    	alert("<?php _e( "These features are only available in Premium Editions!", "gallery-bank" ); ?>");
	    }
