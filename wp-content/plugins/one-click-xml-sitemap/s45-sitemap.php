...
<h3>View Sitemap <a href="<?php echo get_site_url(); ?>/sitemap.xml" target="_blank" target="Studio45 Sitemap" >Click Here</a> </h3>
<h3>View Url list <a href="<?php echo get_site_url(); ?>/urllist.txt" target="_blank" target="Studio45 Sitemap" >Click Here</a> </h3>
